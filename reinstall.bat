...
set confhome=https://raw.githubusercontent.com/yanteams/windows-installer/main
set confhome_cn=https://cnb.cool/yanteams/windows-installer/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/yanteams/windows-installer/main
