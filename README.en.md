...
[![Lines of Code](https://aschey.tech/tokei/github/yanteams/windows-installer?category=code&label=Lines%20of%20Code&style=flat-square)](https://github.com/aschey/vercel-tokei)
<!-- [![Lines of Code](https://tokei.rs/b1/github/yanteams/windows-installer?category=code&label=Lines%20of%20Code&style=flat-square)](https://github.com/XAMPPRocky/tokei_rs) -->
...
[![Donate](https://img.shields.io/badge/Donate-30363D?style=for-the-badge&logo=GitHub-Sponsors&logoColor=#EA4AAA)](https://github.com/sponsors/yanteams)

[![Sponsors](https://raw.githubusercontent.com/yanteams/sponsors/refs/heads/master/sponsors.svg)](https://github.com/sponsors/yanteams)

### Feedback

[![GitHub Issues](https://img.shields.io/badge/GitHub-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/yanteams/windows-installer/issues)
...
| <img width="16" height="16" src="https://github.com/yanteams/windows-installer/assets/7548515/f74b3d5b-085f-4df3-bcc9-8a9bd80bb16d" /> Kali                                                                                                                                                                                                                           | Rolling                               | 256 MB    | 1 ~ 1.5 GB ^     |
...
```bash
curl -O https://raw.githubusercontent.com/yanteams/windows-installer/main/reinstall.sh || wget -O ${_##*/} $_
```

For server inside China:

```bash
curl -O https://cnb.cool/yanteams/windows-installer/-/git/raw/main/reinstall.sh || wget -O ${_##*/} $_
```
...
- <https://raw.githubusercontent.com/yanteams/windows-installer/main/reinstall.bat>
...
```batch
certutil -urlcache -f -split https://raw.githubusercontent.com/yanteams/windows-installer/main/reinstall.bat
```

For server inside China:

```batch
certutil -urlcache -f -split https://cnb.cool/yanteams/windows-installer/-/git/raw/main/reinstall.bat
```
...
![Windows Installation](https://github.com/yanteams/windows-installer/assets/7548515/07c1aea2-1ce3-4967-904f-aaf9d6eec3f7)
...
![image-name](https://github.com/yanteams/windows-installer/assets/7548515/5aae0a9b-61e2-4f66-bb98-d470a6beaac2)
...
Go to <https://github.com/yanteams/windows-installer/commits/main> and find the old version’s `commit_id` on the right side.

```bash
commit_id=xxxxxxx
curl -O https://raw.githubusercontent.com/yanteams/windows-installer/$commit_id/reinstall.sh || wget -O ${_##*/} $_
